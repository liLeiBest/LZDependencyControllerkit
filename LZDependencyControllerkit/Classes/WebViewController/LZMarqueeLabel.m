...
@interface LZMarqueeLabel ()<UIScrollViewDelegate> {
...
- (void)drawTextInRect:(CGRect)rect {
    ...
    if (self.marqueeLabelType == LZMarqueeLabelTypeLeft) {
...
- (void)commonInit {
    ...
    self.marqueeLabelType = LZMarqueeLabelTypeLeftRight;
